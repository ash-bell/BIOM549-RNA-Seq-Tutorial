...
author: "Presented by Dr. Sally Rogers, written by Ashley Bell"
date: "30/11/2023"
...
|------------------------|---------------|-------------------------------------|
|Thu 30th Nov 15:30 - 18:30|Old Library 137|Installing R and analysis walkthrough|
|Wed 13th Dec 13:30 - 16:00|Amory B105     |How to present your data             |
"
cat(tabl)
```
If you have any questions or queries outside of these times, you can
email me at [s.rogers\@exeter.ac.uk](mailto:s.rogers@exeter.ac.uk){.email}
...
### Data set link
You can get access to the data sets required for this workshop on the GitHub link here [Data](https://github.com/ash-bell/BIOM549-RNA-Seq-Tutorial/tree/main/data). You will need the **count_data.csv**, **metadata.csv** and **Gene_annotations.tsv** files. 

### Your task
You are to provide a maximum of three plots that best answer the experimental questions set above for feedback in two weeks time - Wed 13th Dec. See the **EXTRA: Better plotting examples** for ideas to improve your plots.

During the Wed 13th Dec session I will go through your plots and help troubleshoot any issues. At the end of the second session you should have planned out and started on your poster due at the end of Term 2.
