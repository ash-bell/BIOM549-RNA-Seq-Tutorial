...
### Your task
You are to provide a maximum of three plots that best answer the hypotheses set above for feedback in two weeks time - Tues 13 Dec. See the **EXTRA: Better plotting examples** for ideas to improve your plots.
