...
would highly recommend you attend them.Before you attend the first session, you need to have install RStudio and all packages required for this tutorial. You can find instructions on how to do this on the [Installation](#-Installation) tab. 
